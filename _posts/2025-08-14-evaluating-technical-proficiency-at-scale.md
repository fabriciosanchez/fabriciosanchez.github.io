...
{% include image.html img="../assets/img/illiteracy-graphical-definition.webp" alt="Visal definition of functional illiteracy" lightbox="true" caption="Figure 1. Visual definition of functional illiteracy (Source: Barbara Bush Litercy Foundation)" align="left" %}
...
As a Brazilian native, I feel compelled to highlight Brazil’s unique context. As the largest country in Latin America and one of the world’s biggest economies, Brazil’s significance is undeniable. Yet, despite its global relevance, the country continues to grapple with high poverty rates—about **59 million people** live below the World Bank’s poverty line—and persistent social inequality, making Brazil a critical case study.
...
![AIRA random words test](../assets/img/aira-online-test-student.png)
...
![Educator interacting with some student's results](../assets/img/educator-interacting-with-results.png)
...
![Sys Admin creating a new test within AIRA](../assets/img/sys-admin-creating-test.png)
...
![AIRA Students Dashboard](../assets/img/aira-dashboard-2.png)
...
![AIRA cloud architecture](../assets/img/aira-architecture-named.png)
